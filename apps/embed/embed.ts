...
(function() {
  ...
  if (!organizationId) {
    console.error('NeuralDesk Widget: data-organization-id attribute is required');
    return;
  }
  ...
  function render() {
    ...
    button.id = 'neuraldesk-widget-button';
    ...
    container.id = 'neuraldesk-widget-container';
  ...
  (window as any).NeuralDeskWidget = {
    init: reinit,
    show,
    hide,
    destroy
